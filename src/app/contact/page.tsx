                    ...
                    <motion.div variants={item} className="space-y-6 pt-4">
                        <div className="flex items-center gap-4 group">
                            ...
                            <div>
                                ...
                                <a href="mailto:hello@webestone.com" className="text-lg font-semibold hover:text-neon-green transition-colors">hello@webestone.com</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 group">
                            ...
                            <div>
                                ...
                                <a href="tel:+1234567890" className="text-lg font-semibold hover:text-blue-400 transition-colors">+1 (234) 567-890</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 group">
                            ...
                            <div>
                                ...
                                <p className="text-lg font-semibold leading-tight">123 Innovation Blvd, <br />Tech City, TC 90210</p>
                            </div>
                        </div>
                    </motion.div>
                </motion.div>
                    ...
                    <form className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input type="text" id="name" className="w-full bg-black/20 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-neon-green focus:bg-white/5 transition-all" placeholder="John Doe" />
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="email" className="text-sm text-neutral-400">Email Address</label>
                                <input type="email" id="email" className="w-full bg-black/20 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-neon-green focus:bg-white/5 transition-all" placeholder="john@example.com" />
                            </div>
                        </div>

                        <div className="space-y-2">
                            <label htmlFor="subject" className="text-sm text-neutral-400">Subject</label>
                            <select id="subject" className="w-full bg-black/20 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-neon-green focus:bg-white/5 transition-all appearance-none cursor-pointer">
                                <option className="bg-neutral-900">General Inquiry</option>
                                <option className="bg-neutral-900">Project Proposal</option>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea id="message" rows={5} className="w-full bg-black/20 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-neon-green focus:bg-white/5 transition-all resize-none" placeholder="Tell us about your project..."></textarea>
                        </div>

                        <motion.button
                            whileHover={{ scale: 1.02, backgroundColor: "#00ff9d", color: "#000" }}
                            whileTap={{ scale: 0.98 }}
                            className="w-full py-4 bg-white text-black font-bold rounded-lg flex items-center justify-center gap-2 group transition-all duration-300"
                        >
                            Send Message
